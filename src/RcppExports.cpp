...
// rcpp_lm_gaga
Rcpp::List rcpp_lm_gaga(Eigen::MatrixXd X, Eigen::MatrixXd y, SEXP s_alpha, SEXP s_itrNum, SEXP s_thresh, SEXP s_QR_flag, SEXP s_flag, SEXP s_lamda_0, SEXP s_fix_sigma, SEXP s_sigm2_0, SEXP s_fdiag, SEXP s_frp);
RcppExport SEXP _GAGAs_rcpp_lm_gaga(SEXP XSEXP, SEXP ySEXP, SEXP s_alphaSEXP, SEXP s_itrNumSEXP, SEXP s_threshSEXP, SEXP s_QR_flagSEXP, SEXP s_flagSEXP, SEXP s_lamda_0SEXP, SEXP s_fix_sigmaSEXP, SEXP s_sigm2_0SEXP, SEXP s_fdiagSEXP, SEXP s_frpSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SEXP >::type s_frp(s_frpSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_lm_gaga(X, y, s_alpha, s_itrNum, s_thresh, s_QR_flag, s_flag, s_lamda_0, s_fix_sigma, s_sigm2_0, s_fdiag, s_frp));
...
RcppExport void R_init_GAGAs(DllInfo *dll) {
